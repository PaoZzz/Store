...
public class AdminUserStudentIntroFrame extends JFrame{
    ...
    public AdminUserStudentIntroFrame(String frameName, String id) {
        try {
            this.student = ServiceBackFactory.getIStudentServiceBackInstance().getStudentInfo(id);
        } catch (Exception e) {
            e.printStackTrace();
        }
